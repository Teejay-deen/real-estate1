        ...
        <div className="flex flex-col items-center gap-8 lg:flex-row">
          ...
          <div className="my-32 w-full border mt-1 flex-1 bg-white border-gray-300 rounded-lg px-6 py-6">
            <div className="flex items-center gap-x-4 mb-8">
              ...
              <Link to="" className="text-violet-700 text-sm flex">
                View Listing
              </Link>
            </div>
            ...
            <form className="flex flex-col gap-y-4">
              <input
                className="border border-gray-300 focus:border-violet-500 outline-none rounded-lg w-full px-4 h-14 text-sm"
                type="text"
              placeholder="Name*"/>
              <input
                className="border border-gray-300 focus:border-violet-500 outline-none rounded-lg w-full px-4 h-14 text-sm"
              ...
              <textarea defaultValue="Hello Tajudeen, I am Interested in [Modern Appartment]" placeholder="Message*" className="border border-gray-300 outline-none resize-none rounded-lg p-4 text-sm text-gray-400  focus:border-violet-600 w-full h-28"></textarea>
